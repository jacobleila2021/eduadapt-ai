...
ADAPTATION_SPECS = [
    ...
    },
    {
        ...
        "generate": True,
        "hint": "Full classroom lesson a teacher can deliver: Hook → Teach concepts → Guided practice → Independent practice → Mastery check → Exam Practice/Board Check. UDL layout with coloured boxes. Leave mermaid/svg empty for Alora built flowcharts. Board-style questions with model answers from source.",
    },
    {
        "id": "ld",
        "tab": "Dyslexia Smart",
        ...
        "generate": True,
        "hint": "Full classroom lesson at source grade depth (same concepts and exam vocabulary as Mainstream). Accessibility only: chunked bullets (6–10 per section), bold **key terms**, spacing, dyslexia-friendly layout — NOT Grade 3–4 content collapse. Include Exam Practice/Board Check students can answer from this tab alone.",
    },
    {
        "id": "dyslexia",
        "tab": "Dyslexia",
    ...
    },
    {
        ...
        "generate": True,
        "hint": "Full classroom lesson with visual presentation: colour-coded stages, icon markers. Same exam depth as Mainstream. Practice: Q1/A1 on separate lines (≥5 pairs) plus Exam Practice/Board Check. Leave mermaid/svg empty for built flowcharts.",
    },
    {
        "id": "auditory",
        ...
        "generate": True,
        "hint": "Full classroom listen-and-repeat lesson: prose paragraphs (120+ words per section), Say:/Repeat: cues — NOT bullet lists. Same concepts and Exam Practice/Board Check depth as Mainstream.",
    },
    {
        "id": "ell",
        ...
        "generate": True,
        "hint": "Full classroom lesson with ELL scaffolds: glossary beside exam terms, sentence frames, cognates — keep board vocabulary. Include Exam Practice/Board Check at source grade depth.",
    },
    {
        "id": "gifted",
